...
DB = SqliteDatabase('predictions_exercise.db') #here we are creating the predictions_exercise database, so we can give the name we want


class Prediction(Model):
    observation_id = IntegerField(unique=True) #these names (observation_id observation proba true_class) are the actual names that will be saved in the DB 
